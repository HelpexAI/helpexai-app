  ...
  return (
    <button
      ...
      className={`relative h-6 w-11 shrink-0 rounded-full transition ${
        checked ? "bg-[#2b7fff]" : "bg-zinc-200 dark:bg-zinc-700"
  ...
  return (
    <label className="block space-y-2">
      ...
      <div className="relative">
        <input type={visible ? "text" : "password"} required value={value} onChange={(event) => onChange(event.target.value)} className="h-11 w-full rounded-lg border border-zinc-200 bg-white px-4 pr-11 text-sm outline-none transition focus:border-[#2b7fff] dark:border-zinc-700 dark:bg-zinc-950" />
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <section className="min-w-0 flex-1 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
          ...
          {tab === "profile" && <div className="space-y-6">
            <div className="flex flex-col items-center gap-3 border-b border-zinc-200 pb-6 dark:border-zinc-800"><div className="flex size-20 items-center justify-center rounded-full bg-blue-50 text-2xl font-bold text-[#2b7fff] dark:bg-blue-950/40">{workspace.initials}</div><h2 className="text-xl font-bold">{name}</h2><span className="rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-semibold text-[#2b7fff] dark:border-blue-900 dark:bg-blue-950/40">Helpex {workspace.category === "business" ? "Business" : "Legal"}</span></div>
            <label className="block space-y-2"><span className="text-sm font-semibold">Full Name</span><input value={name} onChange={(event) => setName(event.target.value)} className="h-11 w-full rounded-lg border border-zinc-200 bg-white px-4 text-sm outline-none focus:border-[#2b7fff] dark:border-zinc-700 dark:bg-zinc-950" /></label>
