...
} from "@/components/conversations/conversation-sidebar";
...
export function ConversationHub({
  ...
  return (
    <div className="flex min-h-[calc(100vh-4rem)]">
      ...
      <section className="flex flex-1 items-start justify-center bg-slate-50 p-4 pt-4 dark:bg-zinc-950 sm:p-8 sm:pt-16">
        <div className="w-full max-w-lg">
          {conversations.length > 0 && (
            <button
              type="button"
              onClick={() => setMobileConversationsOpen(true)}
              className="mb-4 flex h-10 items-center gap-2 rounded-lg border border-zinc-200 bg-white px-3 text-sm font-semibold shadow-sm dark:border-zinc-700 dark:bg-zinc-900 md:hidden"
            >
              <List className="size-4 text-theme-primary" />
              View conversations
            </button>
          )}
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-8">
            <div className="mx-auto flex size-16 items-center justify-center rounded-2xl bg-theme-soft text-theme-primary dark:bg-theme-soft-dark dark:text-theme-soft-foreground-dark">
      ...
      <ResponsiveModal
        ...
        ariaLabel="Select conversation documents"
      >
