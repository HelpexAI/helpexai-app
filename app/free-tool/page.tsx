...
export const metadata = createPageMetadata(PUBLIC_PAGE_SEO.freeTool);
...
export default function FreeToolPage() {
  const jsonLd = {
    ...
    "@graph": [
      webPageJsonLd(PUBLIC_PAGE_SEO.freeTool),
      breadcrumbJsonLd([
        { name: "Home", path: "/" },
        { name: "Free Document AI Tool", path: "/free-tool" },
      ]),
    ],
  };
