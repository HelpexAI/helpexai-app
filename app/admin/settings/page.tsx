...
export default async function AdminSettingsPage() {
  ...
  const [products, collections, tags, reportTemplates, plans, themes] = await Promise.all([
    ...
    service.from("themes").select("id,slug,name,description,primary_color,primary_hover_color,primary_foreground_color,soft_color,soft_dark_color,soft_foreground_color,soft_foreground_dark_color,border_color,border_dark_color,is_active,sort_order").order("sort_order"),
  ]);
  return (
    <AdminSettingsPanel
